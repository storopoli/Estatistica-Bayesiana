...
![Modelo Hierarquico](https://media.springernature.com/lw685/springer-static/image/art%3A10.1186%2Fs12936-018-2631-8/MediaObjects/12936_2018_2631_Fig1_HTML.png)
...
No terceiro exemplo vamos usar um modelo que cada grupo de `cheese` recebe uma constanten diferente e um coeficiente diferente para `background`:
...
![Ricz Dataset](https://uoftcoders.github.io/rcourse/image/RIKZ_data.png)
