...
Vamos começar com o caso simples da [Aula 6 - Regressão Linear](6-Regressao_Linear.html)
...
Vamos utilizar o caso da [Aula 7 - Regressão Logística](7-Regressao_Logistica.html)
...
### Tabela de Regressão Logística/Binomial
