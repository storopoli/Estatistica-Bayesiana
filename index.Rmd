...
* [`brms`](https://github.com/paul-buerkner/brms): similar ao `rstanarm` pois usa a sintaxe familiar de fórmulas do R, mas dá maior flexibilidade na especificação de modelos mais complexos^[e geralmente a amostragem é um pouco mais rápida que o `rstanarm`.].
