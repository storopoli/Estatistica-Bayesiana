...
date: August 1, 2021
citation_url: https://storopoli.io/Estatistica-Bayesiana/3-Distribuicoes_Estatisticas.html
...
A distribuição binomial descreve um evento do número de sucessos em uma sequência de $n$ experimentos independentes, cada um fazendo uma pergunta sim-não. Note que a distribuição de Bernoulli é um caso especial da distribuição binomial no qual o número de experimentos é $1$.
...
A distribuição binomial possui dois parâmetros e sua notação é $Bin(n, p)$ ou $\text{Binomial}(n, p)$:
