...
\begin{frame}[t]{Solução do Problema de Monty Hall}
    \begin{columns}[t]
...
\begin{frame}{A relação entre $p$-valor e $H_0$}
    ...
    \begin{vfilleditems}
        ...
        \item \textbf{Shapiro-Wilk}: $P(D \mid \text{amostra é normal})$
    \end{vfilleditems}
\end{frame}
...
\begin{frame}{Intevalos de Confiança versus Intervalos da \textit{Posteriori}}
    % Falta Fazer
\end{frame}

\begin{frame}{Mas porquê eu nunca vejo estatística sem $p$-valor?}
    \begin{columns}
        \begin{column}{0.8\textwidth}
...
\begin{frame}{Teorema de Bayes como Motor de Inferência}
    ...
    \begin{vfilleditems}
        ...
        \item \footnotesize \textbf{\textit{Posteriori}}: probabilidade posterior do valor do(s) parâmetros após observamos os dados $y$
...
\begin{frame}{Vantagens da Estatísca Bayesiana}
    %\begin{table}[h!]
        \scalebox{0.3}{!}{
        \begin{tabular}{|l|p{.3\textwidth}|p{.3\textwidth}|}
        \toprule
        \textbf{Característica} & \textbf{Estatística Bayesiana}                   & \textbf{Estatística Frequentista}                                    \\ \midrule
        Dados                   & Fixos –- Não Aleatórios                          & Incertos –- Aleatórios                                               \\ \midrule
        Parâmetros              & Incertos –- Aleatórios                           & Fixos –- Não Aleatórios                                              \\ \midrule
        Inferência              & Incerteza sobre o valor do parâmetro             & Incerteza sobre um processo de amostragem de uma população infinita  \\ \midrule
        Probabilidade           & Subjetiva                                        & Objetiva (mas com diversos pressupostos dos modelos)                 \\ \midrule
