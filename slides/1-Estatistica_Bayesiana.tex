...
\begin{frame}{Interfaces do \href{https://mc-stan.org}{\texttt{Stan}}\footnote{\textcite{carpenterStanProbabilisticProgramming2017}}}
    \begin{vfilleditems}
...
\begin{frame}{Interfaces Amigáveis do \href{https://mc-stan.org}{\texttt{Stan}}\footnote{\textcite{carpenterStanProbabilisticProgramming2017}}}
Somente para \texttt{R}
    ...
    \item \href{https://github.com/paul-buerkner/brms}{\texttt{brms}} \parencite{brms}: similar ao \texttt{rstanarm} pois usa a sintaxe familiar de fórmulas do \texttt{R}, mas dá maior flexibilidade na especificação de modelos mais complexos\footnote{e geralmente a amostragem é um pouco mais rápida que o \texttt{rstanarm}}.
    \end{vfilleditems}
\end{frame}
...
\begin{frame}{PROBABILIDADE NÃO EXISTE!\footnote{\textcite{definettiTheoryProbability1974}}}
    \begin{columns}
        ...
        \centering
        \includegraphics[width=0.4\textwidth]{../images/finetti.jpg}
        \end{column}
    \end{columns}
\end{frame}
    ...
    \begin{columns}
        \begin{column}{0.6\textwidth}
            \begin{vfilleditems}
                ...
                \item As tentativas são consideradas independentes e, como resultado, exibem outra propriedade importante: \textbf{a ordem não importa}
                \item A frequência é considerada uma \textbf{estatística suficiente}
                \item Dizer que a ordem não importa ou dizer que a única coisa que importa é a frequência são duas maneiras de dizer exatamente a mesma coisa
...
\begin{frame}{Probabilidade Definição Matemática}
...
\begin{frame}{Axiomas da Probabilidade\footnote{\textcite{kolmogorovFoundationsTheoryProbability1933}}}
    \begin{columns}
        ...
        \begin{column}{0.4\textwidth}
        \centering
        \includegraphics[width=0.35\textwidth]{../images/kolmogorov.jpg}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Probabilidade Discreta}
