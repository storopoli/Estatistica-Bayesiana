...
\begin{frame}{\href{https://github.com/paul-buerkner/brms}{\texttt{brms}}\footnote{\textcite{brms}}}
    O \href{https://github.com/paul-buerkner/brms}{\texttt{brms}} alia toda a
...
\begin{frame}{Modelos do \href{https://github.com/paul-buerkner/brms}{\texttt{brms}}}
    ...
    \end{vfilleditems}
\end{frame}
\begin{frame}[fragile]{Exemplo Simples do \href{https://github.com/paul-buerkner/brms}{\texttt{brms}}}
    \begin{lstlisting}
    library(brms)
...
\begin{frame}{\texttt{summary} do \href{https://github.com/paul-buerkner/brms}{\texttt{brms}}}
    \begin{table}[ht]
        \centering
        \begin{tabular}{lrrrrrrr}
        \toprule
...
\begin{frame}{Visualizações do \href{https://github.com/paul-buerkner/brms}{\texttt{brms}}}
% library(ggplot2)
% library(ggdark)
% library(bayesplot)
% library(tikzDevice)
...
\begin{columns}
    \begin{column}{0.5\textwidth}
        \centering
        \begin{figure}
            \resizebox{\linewidth}{!}{\input{images/conditional_effects_wt.tex}}
        \end{figure}
    \end{column}
    \begin{column}{0.5\textwidth}
        \centering
        \begin{figure}
            \resizebox{\linewidth}{!}{\input{images/conditional_effects_am.tex}}
        \end{figure}
    \end{column}
\end{columns}
\end{frame}
...
\begin{frame}{Otimizações do \href{https://github.com/paul-buerkner/brms}{\texttt{brms}}}
    \small
    \begin{vfilleditems}
        \item Por padrão \href{https://github.com/paul-buerkner/brms}{\texttt{brms}}
...
\begin{frame}[fragile]{\textit{Backend} \href{https://mc-stan.org/cmdstanr/}{\texttt{CmdStanR}} com o \href{https://github.com/paul-buerkner/brms}{\texttt{brms}}}
    Além disso, \href{https://github.com/paul-buerkner/brms}{\texttt{brms}} permite
