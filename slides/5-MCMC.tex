...
\begin{frame}{Classe de Algoritmos MCMC - Hamiltoninan Monte Carlo (HMC)}
  \begin{columns}
    \begin{column}{0.8\textwidth}
      ...
      multidimensionais nas quais a topologia da posterior é complexa
...
\begin{frame}{O que muda com HMC?}
  ...
  eficiente a topologia de uma probabilidade posterior.
  \vfill
  Além de explorar melhor a topologia da posterior e tolerar topologias complexas,
...
\begin{frame}[fragile]{Algoritmo de HMC}
    ...
    Simultaneamente amostre $\boldsymbol{\theta}$ e $\boldsymbol{\phi}$ com $L$ passos cada um reduzido por um fator $\epsilon$.\;
    \Para{$1, 2, \dots, L$}{
...
\begin{frame}{Um interlúdio de Integrador Numéricos}
  ...
  sistema de equações diferenciais ordinais ao aplicar um pequeno passo $\epsilon$.
  ...
  usa-se um passo $\epsilon$ para calcular a solução numérica do estado em um futuro
  tempo $t$ a partir de condições inciais específicas.
\end{frame}
...
\begin{frame}{Um interlúdio de Integrador Numéricos}
  \begin{columns}
    \begin{column}{0.6\textwidth}
      ...
      Liouville. Isto faz com que o método de Euler seja umá péssima escolha como
      integrador numérico de um algoritmo HMC.
    \end{column}
    \begin{column}{0.4\textwidth}
      \begin{figure}
      \includegraphics[width=0.9\columnwidth]{euler_0_3.jpg}
...
\begin{frame}{Um interlúdio de Integrador Numéricos}
  \begin{columns}
    \begin{column}{0.6\textwidth}
      ...
      de ordem 2 e precisam ser usados com um passo $\epsilon$ constante.
    ...
    \begin{column}{0.4\textwidth}
      \begin{figure}
        \includegraphics[width=0.9\columnwidth]{leapfrog_0_3.jpg}
...
\begin{frame}{Limitações do Algorito HMC}
  \begin{columns}
    \begin{column}{0.6\textwidth}
      ...
      de meio-passos $L$ e do fator de redução $\epsilon$. Em especial o integrador
    ...
    \begin{column}{0.4\textwidth}
      \begin{figure}
        \includegraphics[width=0.9\columnwidth]{leapfrog_1_2.jpg}
...
\begin{frame}{Limitações do Algorito HMC - Funil de \textcite{nealSliceSampling2003}}
  O famoso funil da morte \footnote{muito comum em modelos hierárquicos}. Aqui vemos que o algoritmo HMC, durante a exploração da
  posterior, tem que a todo momento trocar de valores de $L$ e $\epsilon$.
...
% plt.savefig('slides/images/funnel.png', bbox_inches=0, transparent=True, dpi=300)
  \centering
  \includegraphics[width=0.7\textwidth]{funnel.png}
\end{frame}
