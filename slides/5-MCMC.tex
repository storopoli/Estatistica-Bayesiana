...
\begin{frame}{Markov Chain Monte Carlo - MCMC - Leituras Recomendadas}
    \begin{vfilleditems}
        ...
        \end{vfilleditems}
        \item \citet*{mcelreath2020statistical} - Capítulo 9: Markov Chain Monte Carlo
        \item \citet*{neal2011mcmc}
        \item \citet*{betancourtConceptualIntroductionHamiltonian2017}
        \item \citet*{gelman2020regression} - Capítulo 22, Seção 22.8: Computational efficiency
        \item \citet*{storopoli2021estatisticabayesianaR} - Markov Chain Monte Carlo
        \item \citet*{chibUnderstandingMetropolisHastingsAlgorithm1995}
        \item \citet*{casellaExplainingGibbsSampler1992}
    \end{vfilleditems}
\end{frame}
...
Veja Metropolis em ação no \href{https://chi-feng.github.io/mcmc-demo/app.html?algorithm=RandomWalkMH&target=banana}{\texttt{chi-feng/mcmc-demo}}
    \footnotesize
...
Veja Gibbs em ação no \href{https://chi-feng.github.io/mcmc-demo/app.html?algorithm=GibbsSampling&target=banana}{\texttt{chi-feng/mcmc-demo}}
    \footnotesize
...
\begin{frame}[fragile]{Algoritmo de HMC\footnote{\citet{neal2011mcmc}}}
    ...
    Veja HMC em ação no \href{https://chi-feng.github.io/mcmc-demo/app.html?algorithm=HamiltonianHMC&target=banana}{\texttt{chi-feng/mcmc-demo}}
    \footnotesize
...
\begin{frame}{Algoritmo de NUTS\footnote{\citet*{hoffman2014no}}}

    Veja NUTS em ação no \href{https://chi-feng.github.io/mcmc-demo/app.html?algorithm=EfficientNUTS&target=banana}{\texttt{chi-feng/mcmc-demo}}
