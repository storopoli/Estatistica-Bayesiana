...
```{r mle-vs-posterior, echo = FALSE, warning=FALSE, fig.show='hold', out.width='33%', fig.align='default', fig.cap='Da esquerda para direita: Estimação de Máxima Verossimilhança e Intervalo de Credibilidade'}
library(cowplot)
library(patchwork)
library(ggplot2)
library(tibble)
