...
```{r finetti, echo=FALSE, out.width='30%', fig.cap='Bruno de Finetti. Figura de https://www.wikipedia.org', out.extra='class=external'}
...
```{r kolmogorov, echo=FALSE, out.width='30%', fig.cap='Andrey Nikolaevich Kolmogorov. Figura de https://www.wikipedia.org', out.extra='class=external'}
