...
| `prior`            | Todas funções de modelagem                                     | Coeficientes de Regressão, não inclui coeficientes que variam por grupo em modelso multiníveis (veja `prior_covariance`)    |
...
* Coeficientes: para cada coeficiente média $\mu = 0$ and standard deviation of $2.5\times\frac{\sigma_y}{\sigma_{x_k}}$ - `prior = normal(0, 2.5 * sd_y/sd_xk)`
